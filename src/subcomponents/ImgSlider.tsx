...
const ImgSlider = ({ title, src, img, setIsOpen }: CardDetailProps) => {
  ...
  return (
    <div className=' fixed top-0 left-0 w-full h-full bg-black/50 z-10 overflow-auto'>
        <div className=' absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] flex-center-col w-full h-full md:w-[80%] md:h-[80%] md:rounded-md bg-white dark:bg-slate-800 z-20'>
